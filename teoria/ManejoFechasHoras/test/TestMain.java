...
public class TestMain {
    public static void main(String[] args) {
        ...
        DateTimeFormatter formatoEspMex = DateTimeFormatter.ofPattern("EEEE, dd MMMM yyyy", Locale.of("es", "MX"));
        System.out.println("Fecha actual (Español México): " + ahora.format(formatoEspMex));
    }
}
