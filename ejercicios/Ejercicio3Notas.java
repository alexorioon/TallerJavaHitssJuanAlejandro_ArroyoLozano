...
public class Ejercicio3Notas {
    ...
    public static void main(String[] args) {
        ...
        double nota, notas = 0, notasMayorA6 = 0, notasMenorA6 = 0;
        int cantIgualA1 = 0, cantMayorOIgualA6 = 0, cantMenorA6 = 0;
        ...
        System.out.printf("%nPromedio Mayor o Igual a 6 (%.2f/%d): %.2f%n", notasMayorA6, cantMayorOIgualA6, notasMayorA6 / cantMayorOIgualA6);
        System.out.printf("Promedio Menor a 6 (%.2f/%d): %.2f%n", notasMenorA6, cantMenorA6, notasMenorA6 / cantMenorA6);
        System.out.println("Cantidad igual a 1: " + cantIgualA1);
        System.out.printf("Promedio general (%.2f/%d): %.2f", notas, CANTIDAD_NOTAS, notas / CANTIDAD_NOTAS);
        entrada.close();
    }
}
