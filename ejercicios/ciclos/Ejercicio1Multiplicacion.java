...
public class Ejercicio1Multiplicacion {
  ...
  public static void main(String[] args) {
    ...
    esNegativo =
      ...
      (multiplicando >= 0 && multiplicador < 0);
    if (multiplicando < 0) multiplicando = -multiplicando;

    if (multiplicador < 0) multiplicador = -multiplicador;

    for (int i = 1; i <= multiplicador; i++) producto += multiplicando;

    if (esNegativo) producto = -producto;
